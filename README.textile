...
jddl (Java Direct Downloader) is a simple and lightweight java library, which makes it very easy and trivial to direct-download multiple files over HTTP and to track the download progress.

Note: Support for HTTPS and FTP downloads will be added in future releases 
